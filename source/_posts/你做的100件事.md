...
<div class="a100">
    <p> 1. 戴同一幅耳机听喜欢的音乐 <input type="checkbox"></p>
    <p> 2. 带你回家乡 <input type="checkbox"></p>
    <p> 3. 一起数星星 <input type="checkbox"></p>
    <p> 4. 生日在一起许愿 <input type="checkbox"></p>
    <p> 5. 一起吃棉花糖 <input type="checkbox"></p>
    <p> 6. 分享彼此的梦想 <input type="checkbox"></p>
    <p> 7. 一起通宵跨年守岁 <input type="checkbox"></p>
    <p> 8. 一起骑自行车 <input type="checkbox"></p>
    <p> 9. 一起洗衣服 <input type="checkbox"></p>
    <p> 10. 去北方看雪 <input type="checkbox"></p>
    <p> 11. 手牵手逛街 <input type="checkbox" checked></p>
    <p> 12. 将一起拍的照片做成一个相册 <input type="checkbox"></p>
    <p> 13. 一起去鬼屋 <input type="checkbox"></p>
    <p> 14. 一起荡秋千 <input type="checkbox"></p>
    <p> 15. 为对方取一个专属昵称 <input type="checkbox" checked></p>
    <p> 16. 穿过同一件衣服 <input type="checkbox"></p>
    <p> 17. 买个红薯一人一半分着吃 <input type="checkbox"></p>
    <p> 18. 一个早安吻 <input type="checkbox"></p>
    <p> 19. 陪对方去做一件TA喜欢但自己不感兴趣的事情 <input type="checkbox"></p>
    <p> 20. 你为我刮胡子，我为你梳头 <input type="checkbox"></p>
    <p> 21. 在朋友圈秀一次恩爱 <input type="checkbox" checked></p>
    <p> 22. 一起滑冰 <input type="checkbox"></p>
    <p> 23. 去坐旋转木马 <input type="checkbox"></p>
    <p> 24. 去吃热气腾腾的火锅 <input type="checkbox"></p>
    <p> 25. 面对面读一本书 <input type="checkbox"></p>
    <p> 26. 为我织一件东西 <input type="checkbox"></p>
    <p> 27. 生病的时候陪着我 <input type="checkbox"></p>
    <p> 28. 帮你吹头发 <input type="checkbox"></p>
    <p> 29. 背着你走一段路 <input type="checkbox" checked></p>
    <p> 30. 一起赏月 <input type="checkbox"></p>
    <p> 31. 坐没坐过的车去玩 <input type="checkbox"></p>
    <p> 32. 一起喝醉 <input type="checkbox"></p>
    <p> 33. 吃完饭一起刷碗 <input type="checkbox"></p>
    <p> 34. 在大街上互相拥抱 <input type="checkbox" checked></p>
    <p> 35. 一起养一条小狗 <input type="checkbox"></p>
    <p> 36. 一起换情侣头像 <input type="checkbox" checked></p>
    <p> 37. 一起听同一首歌 <input type="checkbox" checked></p>
    <p> 38. 在朋友面前介绍对方 <input type="checkbox" ></p>
    <p> 39. 一起做运动 <input type="checkbox"></p>
    <p> 40. 一起去图书馆 <input type="checkbox"></p>
